...
class MeiRepository
{
    public static function getAtividadesEconomicasArray(): array
    {
        return [
            ...
            'REPARADOR(A) DE MÁQUINAS GRÁFICA INDEPENDENTE E APARELHOS PARA A INDÚSTRIA',
            ...
            'REPARADOR(A) INDEPENDENTE DE MÁQUINAS MOTRIZES NÃO ELÉTRICAS',
            ...
            'RESTAURADOR(A) INDEPENDENTE DE JOGOS ACIONADOS POR MOEDAS',
            'RESTAURADOR(A) DE LIVROS NDEPENDENTE',
