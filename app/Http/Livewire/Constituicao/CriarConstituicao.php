...
class CriarConstituicao extends Component
{
    ...
    public string $porte = 'ME';
    public string $simples = 'SIM';
    ...
    public string $assinaturaContrato = 'GOV.BR';
    ...
    public function render()
    {
        ...
        return view('livewire.constituicao.criar-constituicao', [
