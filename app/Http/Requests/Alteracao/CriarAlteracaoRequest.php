...
class CriarAlteracaoRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'tipo_unidade' => ['nullable', Rule::in(['UNIDADE PRODUTIVA', 'SEDE', 'ESCRITÓRIO ADMINISTRATIVO', 'DEPÓSITO FECHADO', 'ALMOXARIFADO', 'OFICINA DE REPARAÇÃO', 'GARAGEM', 'UNIDADE DE ABASTECIMENTO DE COMBUSTÍVEIS', 'PONTO DE EXPOSIÇÃO', 'CENTRO DE TREINAMENTO', 'CENTRO DE PROCESSAMENTO DE DADOS', 'POSTO DE COLETA', 'POSTO DE SERVIÇO'])],
            'forma_atuacao' => ['nullable', Rule::in(['ESTABELECIMENTO FIXO', 'INTERNET', 'EM LOCAL FIXO FORA DE LOJA', 'CORREIO', 'TELEVENDAS', 'PORTA A PORTA, POSTOS MOVEIS OU POR AMBULANTES', 'MÁQUINAS AUTOMÁTICAS', 'ATIVIDADE DESENVOLVIDA FORA DO ESTABELECIMENTO', 'E-Commerce'])],
            'inocuo_virtual' => ['nullable', Rule::in(['SIM', 'NÃO'])],
            'residencia_empreendedor' => ['nullable', Rule::in(['SIM', 'NÃO'])],
            'quantidade_ambiente' => 'nullable',
            'subsolo_estacionamento' => ['nullable', Rule::in(['SIM', 'NÃO'])],
            'quantidade_combustivel' => 'nullable',
            'quantidade_petroleo' => 'nullable',
            'objeto' => 'nullable',
            'cnae' => 'nullable',
