            ...
            @foreach($meis as $mei)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td>
                        ...
                        <button wire:click="$emit('openModal', 'modals.mei.delete-mei-modal', @json([$mei->id]))" title="Excluir Solicitação" class="focus:outline-none text-white bg-red-500 hover:bg-red-400 focus:ring-4 focus:ring-red-300 font-medium rounded text-sm py-1 px-2 mr-2 text-xs dark:focus:ring-red-900">
